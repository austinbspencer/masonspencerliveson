<template>
  <div class="pb-5 pt-5">
    <v-card>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card-text class="pt-3">
            <div v-for="(message, i) in post.message" :key="i">
      ...
      <v-img v-if="post.attachments" :src="post.attachments"></v-img>
      <v-divider></v-divider>
      <v-card-actions>
        ...
        <v-btn color="primary" text right absolute :href="post.url">
          View On Facebook
        </v-btn>
      </v-card-actions>
    </v-card>
