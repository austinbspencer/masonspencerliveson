<template>
  <div>
    ...
    <ul>
      <li>X-rays</li>
      <li>Bone marrow testing</li>
      <li>CT scans</li>
      <li>Ultrasounds</li>
      <li>PET scan (to look for malignancy)</li>
      <li>MRIs</li>
      <li>Tests to look for infections that can be associated with HLH</li>
      <li>Special blood tests that can be done to quickly screen patients for the genetic causes of HLH</li>
